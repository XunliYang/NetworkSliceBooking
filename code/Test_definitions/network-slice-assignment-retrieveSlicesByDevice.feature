Feature: CAMARA Network Slice Assignment API v0.1.0-rc.2 - Operation retrieveSlicesByDevice
  ...
  Background: Common retrieveSlicesByDevice setup
    ...
    And the resource "/network-slice-assignment/v0.1rc2/retrieve-slices"
