Feature: CAMARA Network Slice Assignment API v0.1.0-rc.2 - Operation assignDevice
  ...
  Background: Common assignDevice setup
    ...
    And the resource "/network-slice-assignment/v0.1rc2/slices/{sliceId}/devices"
